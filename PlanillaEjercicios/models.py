...
class Habilidades(models.Model):
    ...
    #traduccion = models.CharField('Traduccion', max_length=200,blank=True,null=True)
    description = models.CharField('titulo',max_length=100,blank=True)
...
class Ejercicios(models.Model):
    ...
    habilidades = models.ManyToManyField(Habilidades,through='HabilidadEjercicio',blank=True)
...
class HabilidadEjercicio(models.Model):
    ...
    ejercicio = models.ForeignKey(Ejercicios, on_delete=models.CASCADE,blank=True, null=True)
